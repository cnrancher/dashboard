...
import { delay, upperFirst } from 'lodash';
  ...
  methods: {
    ...
    initInstanceChargeType() {
      ...
      if (instanceChargeType === 'PrePaid') {
        this.$set(this, 'periodUnit', `${ this.value.period }${ this.value.periodUnit }`);
      }
      ...
      <div class="row mb-20">
        ...
        <div class="col span-6">
          <UnitInput
            ...
            @blur="unitInputRangeLimit(systemDiskCategorySize.Min, systemDiskCategorySize.Max, 'systemDiskSize')"
          />
        </div>
      </div>
        ...
        <div class="row mb-20">
          ...
          <div class="col span-6">
            <UnitInput
              ...
              @blur="unitInputRangeLimit(diskCategorySize.Min, diskCategorySize.Max, 'diskSize')"
            />
          </div>
        </div>
