...
export default [
  ...
  },
  {
    ...
    children:  [
      ...
      {
        path:      '/auth/mfa',
        component: () => interopDefault(import('@shell/pages/auth/mfa.vue')),
        name:      'auth-mfa'
      }, {
        path:      '/auth/verify-mfa',
        component: () => interopDefault(import('@shell/pages/auth/verify-mfa.vue')),
        name:      'auth-verify-mfa'
      }, {
        path:      '/auth/regist-mfa',
        component: () => interopDefault(import('@shell/pages/auth/regist-mfa.vue')),
  ...
  },
  {
    ...
    children:  [
      ...
      },
      {
        ...
        component: () => interopDefault(import('@shell/pages/c/_cluster/logging/extension.vue')),
      ...
      },
      {
        ...
        component: () => interopDefault(import('@shell/pages/c/_cluster/manager/globalMonitoring/_dashboard.vue')),
