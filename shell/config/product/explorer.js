...
import { FLAT_NETWORKS_UI_EXTENSION, AUDIT_LOG_UI_EXTENSION } from '@shell/store/features';
...
export function init(store) {
  ...
  headers(SERVICE, [STATE, NAME_COL, NAMESPACE_COL, TARGET_PORT, SELECTOR, SPEC_TYPE, CLUSTER_IP, AGE]);
